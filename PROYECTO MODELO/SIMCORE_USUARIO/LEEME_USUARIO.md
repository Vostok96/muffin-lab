# SIMCORE - Captura perfil usuario operativo

Esta carpeta contiene la captura visible del SIMCORE WEB iniciando sesion como usuario operativo.
...
La credencial indicada para esta segunda captura no inicio sesion y devolvio la pantalla de login. Para no dejar una carpeta falsa, se rehizo la captura con un usuario operativo valido que si entro a SIMCORE. No se guardan usuarios ni passwords reales en esta carpeta.
